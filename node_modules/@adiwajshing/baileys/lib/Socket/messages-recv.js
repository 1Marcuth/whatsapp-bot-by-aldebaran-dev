...
const makeMessagesRecvSocket = (config) => {
    ...
    const { ev, authState, ws, onUnexpectedError, assertSessions, assertingPreKeys, sendNode, relayMessage, sendReceipt, resyncMainAppState, } = sock;
    ...
    const handleUpsertedMessages = async ({ messages, type }) => {
        ...
        if (type === 'notify' || type === 'append') {
            const chatId = WABinary_1.jidNormalizedUser(messages[0].key.remoteJid);
            ...
            for (const msg of messages) {
                ...
                await processingMutex.mutex('p-' + normalizedChatId, () => processMessage(msg, chat));
